...
class TestHttpErrorMiddlewareIntegrational(TrialTestCase):
    ...
    def test_middleware_works(self):
        ...
        self.assertEqual(get_value('httperror/response_dropped_count'), 3)
        self.assertEqual(get_value('httperror/response_dropped_status_count/404'), 1)
        self.assertEqual(get_value('httperror/response_dropped_status_count/402'), 1)
        self.assertEqual(get_value('httperror/response_dropped_status_count/500'), 1)
